...
#include "${testDir}\compute-pi-test.h"

static ComputePiTest suite_ComputePiTest;

static CxxTest::List Tests_ComputePiTest = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_ComputePiTest( "${testDir.unixSlash}/compute-pi-test.h", 5, "ComputePiTest", suite_ComputePiTest, Tests_ComputePiTest );
